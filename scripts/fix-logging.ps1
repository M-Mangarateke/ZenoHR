$file = 'C:\Users\manga\ZenoHR\src\ZenoHR.Infrastructure\Behaviours\LoggingBehaviour.cs'
$content = @'
// REQ-OPS-005: LoggingBehaviour — structured request/response logging for all MediatR commands/queries.
...
Write-Host "Updated LoggingBehaviour.cs"
